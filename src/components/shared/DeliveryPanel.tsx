    ...
    const channel = supabase
      ...
      .on('postgres_changes', {
        ...
        void getDeliveryFiles(sessionId)
          ...
          .catch((refreshError) => {
            console.error('[DeliveryPanel] realtime refresh failed:', refreshError);
            showToast({
              title: 'Actualisation impossible',
              description: 'Les livraisons seront rechargées automatiquement au prochain rafraîchissement.',
              variant: 'destructive',
            });
          });
      })
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        {canUpload ? (
          <button
            ...
            className="inline-flex min-h-[var(--size-touch)] items-center justify-center rounded-xl border border-orange-200 bg-orange-50 px-3 py-2 text-xs font-medium text-orange-600 transition-colors hover:bg-orange-100"
          >
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="inline-flex min-h-[var(--size-touch)] items-center justify-center rounded-xl border border-gray-200 px-3 py-2 text-xs font-medium text-gray-600 transition-colors hover:bg-orange-50 hover:text-orange-600"
                  >
                    Télécharger
                  </button>
                </div>
                ...
                {canDelete ? (
                  <div className="mt-3">
                    <button
                      ...
                      className="inline-flex min-h-[var(--size-touch)] items-center px-2 text-xs font-medium text-red-500 hover:underline disabled:cursor-not-allowed disabled:opacity-50"
                    >
