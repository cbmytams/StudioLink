...
export function RatingModal({
  ...
  return (
    <div className="fixed inset-0 z-modal flex items-center justify-center bg-[var(--color-surface-soft)]/85 p-4 backdrop-blur-sm">
      <FocusTrap>
        <div
          id="rating-modal"
          role="dialog"
          ...
          className="w-full max-w-md rounded-[var(--radius-pill)] border border-white/60 bg-white/95 p-6 shadow-[var(--shadow-lg)]"
        >
          <div className="mb-4 flex items-start justify-between gap-3">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[var(--tracking-xwidecaps)] text-gray-400">Évaluation</p>
              <h2 id="rating-modal-title" className="mt-1 text-xl font-semibold text-gray-900">Comment s&apos;est passée la session ?</h2>
            ...
            <button
              ...
              onClick={onClose}
              className="min-h-[var(--size-touch)] min-w-[var(--size-touch)] rounded-full border border-stone-200 p-2 text-stone-500 transition hover:bg-stone-50"
            >
              <X size={16} />
            </button>
          </div>
          ...
          {loading ? (
            ...
            <div className="space-y-5">
                ...
                {stars.map((value) => {
                  ...
                  return (
                    <button
                      ...
                      className={`min-h-[var(--size-touch)] min-w-[var(--size-touch)] rounded-full text-3xl transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-300 ${
              ...
              <div>
                ...
                />
                <p className="mt-1 text-right text-[var(--text-2xs-plus)] text-gray-400">{comment.length}/500</p>
              </div>
