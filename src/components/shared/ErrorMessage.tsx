    ...
    <div className={`flex flex-col items-center justify-center px-4 py-12 text-center ${className}`}>
      ...
      {onRetry ? (
        <button
          type="button"
          onClick={onRetry}
          className="min-h-[var(--size-touch)] rounded-xl border border-white/20 px-4 py-2 text-sm text-white/85 transition hover:bg-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-300 focus-visible:ring-offset-2 focus-visible:ring-offset-black/40"
        >
          Réessayer
        </button>
      ) : null}
