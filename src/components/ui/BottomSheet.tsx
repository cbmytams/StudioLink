      ...
      {isOpen && (
        <>
          ...
          <FocusTrap>
            ...
            >
              <div className="sticky top-0 bg-[var(--color-surface-soft)]/80 backdrop-blur-md z-10 px-6 py-4 border-b border-black/5 flex items-center justify-between shrink-0">
                ...
                <button
                  ...
                  onClick={onClose}
                  className="min-h-[var(--size-touch)] min-w-[var(--size-touch)] flex items-center justify-center rounded-full bg-black/5 hover:bg-black/10 transition-colors shrink-0"
                >
                  <X size={18} />
                </button>
              </div>
              <div className="flex-1 overflow-y-auto p-6 pb-[var(--safe-offset-expanded)]">
                {children}
              </div>
            </motion.div>
          </FocusTrap>
