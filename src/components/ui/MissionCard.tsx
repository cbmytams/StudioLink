...
export function MissionCard({ mission }: MissionCardProps) {
  ...
  return (
    <GlassCard 
      className="min-h-[120px] p-5 flex flex-col gap-3 cursor-pointer hover:bg-white/50 transition-colors relative overflow-hidden"
    ...
    >
      ...
      <div className="flex justify-between items-start gap-4">
        ...
        <div className="flex flex-col items-end gap-1.5">
          <Badge
            className={cn(
              'normal-case tracking-normal text-[10px] border-none px-2 py-0.5',
              STATUS_CONFIG[mission.status].className,
            )}
          >
