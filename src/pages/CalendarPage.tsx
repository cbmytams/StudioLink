        ...
        <div className="flex flex-col gap-3 mt-2">
          ...
          <div className="flex items-start gap-3 text-sm">
            ...
            <div className="flex flex-col">
              ...
              <button 
                onClick={() => window.location.assign(`https://maps.google.com/?q=${encodeURIComponent(session.studioAddress)}`)}
  ...
  return (
    <div className="min-h-screen bg-[#f4ece4] flex flex-col pt-safe">
      ...
      <header className="px-4 py-6 flex flex-col gap-6 sticky top-0 bg-[#f4ece4]/90 backdrop-blur-md z-30">
        ...
        <div className="flex justify-between items-center">
          <button onClick={handlePrev} className="flex min-h-[44px] min-w-[44px] items-center justify-center rounded-full p-2 transition-colors hover:bg-black/5">
            <ChevronLeft size={24} />
          </button>
          <span className="text-lg font-medium capitalize">{formatMonthYear(currentDate)}</span>
          <button onClick={handleNext} className="flex min-h-[44px] min-w-[44px] items-center justify-center rounded-full p-2 transition-colors hover:bg-black/5">
      ...
      <div className="flex-1 overflow-hidden flex flex-col">
        {mySessions.length === 0 ? (
          <div className="flex flex-1 flex-col items-center justify-center gap-3 px-6 text-center">
            ...
            <p className="text-sm leading-relaxed text-stone-500">Aucune disponibilité définie pour cette période.</p>
          </div>
        ) : (
