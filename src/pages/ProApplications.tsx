...
export default function ProApplications() {
  ...
  return (
    <div className="min-h-screen p-4 pb-24 md:p-8 md:pb-24 max-w-3xl mx-auto relative">
      {/* Background */}
      ...
      <header className="mb-8">
        ...
        <div className="flex items-center gap-2 p-1 bg-white/40 backdrop-blur-md rounded-full border border-white/50 w-fit overflow-x-auto max-w-full hide-scrollbar">
          <button 
            ...
            className={cn(
              "min-h-[44px] px-4 py-2 rounded-full text-sm font-medium transition-all whitespace-nowrap",
                    ...
                    >
                      <GlassCard className="p-5 flex flex-col gap-4">
                        ...
                        <div className="flex items-center gap-2 mt-2">
                          <Button variant="ghost" className="flex-1" onClick={() => navigate(`/pro/missions/${app.missionId}`)}>
                            Voir la mission
                          </Button>
