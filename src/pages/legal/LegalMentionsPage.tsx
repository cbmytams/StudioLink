  ...
  return (
    <div className="app-shell min-h-[100dvh] px-4 py-8">
      ...
      <main className="mx-auto w-full max-w-4xl space-y-6">
        ...
        <section className="app-card space-y-4 p-5 text-sm text-white/75">
          <h2 className="text-lg font-semibold text-white">1. Editeur du site</h2>
          ...
          <h2 className="text-lg font-semibold text-white">2. Hebergement</h2>
          ...
          <h2 className="text-lg font-semibold text-white">3. Infrastructure & base de donnees</h2>
          <p><strong>Supabase Inc.</strong></p>
          <p>San Francisco, CA, Etats-Unis</p>
          <p>Site web : supabase.com</p>

          <h2 className="text-lg font-semibold text-white">4. Propriete intellectuelle</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-white">5. Donnees personnelles</h2>
          <p>
