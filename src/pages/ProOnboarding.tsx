...
import { setOnboardingProgress, updateProfileIdentity, upsertProProfile } from '@/services/profileService';
  ...
  const handleComplete = async () => {
    if (session?.user?.id) {
      await upsertProProfile({
        ...
        name: proData.name || null,
        bio: proData.bio || null,
        phone: proData.phone || null,
        services: proData.services,
        genres: proData.genres,
        instruments: proData.instruments,
        min_rate: proData.minRate,
        show_rate: proData.showRate,
        links: proData.links,
        is_available: true,
      });
      await updateProfileIdentity(session.user.id, {
        display_name: proData.name || null,
        avatar_url: avatar,
      });
                  ...
                  <div className="w-full flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-1 relative">
                      <Textarea 
                        ...
                        value={proData.bio}
                        onChange={(e) => {
                          setProData({ bio: e.target.value.slice(0, 200) });
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="mt-2 flex flex-wrap gap-2">
                      <select 
                        ...
                        className="h-11 rounded-lg border border-stone-200 bg-white/80 px-3 text-sm text-stone-800 focus:border-orange-400 focus:outline-none focus:ring-1 focus:ring-orange-400 transition-colors duration-150"
                      >
